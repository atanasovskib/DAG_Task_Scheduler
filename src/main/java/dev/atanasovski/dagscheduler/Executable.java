...
public abstract class Executable implements Runnable {
    ...
    private final Map<String, List<Object>> inputParameters = new HashMap<>();
    private final Map<String, List<Object>> outputParameters = new HashMap<>();
    ...
    protected List<?> get(String inputName) {
